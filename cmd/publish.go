...
func init() {
	...
	publishCmd.Flags().StringSlice("tags", []string{}, "Specific Apis and Policies tags to publish")
	publishCmd.Flags().StringSlice("categories", []string{}, "Specific Apis categories to publish")
}
