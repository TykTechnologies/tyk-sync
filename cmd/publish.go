...
func init() {
	...
	publishCmd.Flags().StringP("secret", "s", "", "Your API secret for accessing Dashboard or Gateway API. If not set, value of TYKGIT_DB_SECRET environment variable will be used.")
